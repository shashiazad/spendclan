...
export default function AboutPage() {
  return (
    <div className="space-y-10">
      {/* Page header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-100">About SpendClan</h1>
      ...
      <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-8 shadow-2xl shadow-black/30 backdrop-blur-md animate-slide-up">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-slate-100">SpendClan</h2>
      ...
      <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-8 shadow-2xl shadow-black/30 backdrop-blur-md animate-slide-up" style={{ animationDelay: "100ms" }}>
        <h2 className="text-lg font-bold text-slate-100 mb-4">What Makes SpendClan Special</h2>
      ...
      <div className="rounded-2xl border border-slate-800/80 bg-slate-900/70 p-8 shadow-2xl shadow-black/30 backdrop-blur-md animate-slide-up" style={{ animationDelay: "200ms" }}>
        <h2 className="text-lg font-bold text-slate-100 mb-6">Developer</h2>
        ...
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-slate-100">Shashi Azad</h3>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-800/60 px-4 py-2 text-sm font-medium text-slate-300 transition-all hover:border-slate-600 hover:bg-slate-800 hover:text-slate-100"
              >
